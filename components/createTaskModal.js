...
const CreateTaskModal = () => {
  ...
  const {setUserData, setUserId, userId, userTasks} = useContext(UtilsContext);
  ...
  return (
    <View style={styles.centeredView}>
          ...
          <View style={styles.modalView}>
            ...
            <View style={styles.label}>
              ...
              <TextInput
                ...
                value={taskPriority}
                placeholder="Enter taskPriority"
      ...
      <TouchableOpacity
        ...
        <Text style={styles.buttonText}>Add your first Task!</Text>
      </TouchableOpacity>
      <Text>
        {data && data.login === 'success'
          ? `Welcome ${data.userDetails.taskName}!`
          : ''}
      </Text>
    </View>
  );
